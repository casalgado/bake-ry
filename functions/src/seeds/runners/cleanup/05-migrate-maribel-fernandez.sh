#!/bin/bash
# =============================================================================
# Script 5: Migrate Maribel -> Maria Isabel Fernandez de Castro
# =============================================================================
# Phone: 573188660522
# Source (DELETE): udZBlVNkilcPocSLqui5 - "Maribel Fernandez de Castro" (nickname)
# Target (KEEP):   9VpbcqhXOfmnJW0OP2KU - "Maria Isabel Fernandez de Castro" (full name)
# =============================================================================
...
BAKERY="diana_lee"
SOURCE_USER="udZBlVNkilcPocSLqui5"
TARGET_USER="9VpbcqhXOfmnJW0OP2KU"

echo "=============================================="
echo "MIGRATE: Maribel -> Maria Isabel Fernandez de Castro"
echo "Phone: 573188660522"
echo "Bakery: $BAKERY"
echo "=============================================="
echo ""
...
echo "Source User: $SOURCE_USER (Maribel Fernandez de Castro - nickname)"
echo ""
echo "Response:"
...
echo "Target User: $TARGET_USER (Maria Isabel Fernandez de Castro)"
echo ""
