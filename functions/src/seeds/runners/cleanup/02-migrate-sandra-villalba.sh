#!/bin/bash
# =============================================================================
# Script 2: Migrate Sandra Villalba (typo fix)
# =============================================================================
# Phone: 573106398349
# Source (DELETE): TxKTf6ceCFeFDcHu0tzd - "Sanda Villalba" (typo)
# Target (KEEP):   0PKRqtu1njAJKhC0aUyt - "Sandra Villalba"
# =============================================================================
...
BAKERY="diana_lee"
SOURCE_USER="TxKTf6ceCFeFDcHu0tzd"
TARGET_USER="0PKRqtu1njAJKhC0aUyt"

echo "=============================================="
echo "MIGRATE: Sanda Villalba -> Sandra Villalba"
echo "Phone: 573106398349"
echo "Bakery: $BAKERY"
echo "=============================================="
echo ""
...
echo "Source User: $SOURCE_USER (Sanda Villalba - typo)"
echo ""
echo "Response:"
...
echo "Target User: $TARGET_USER (Sandra Villalba)"
echo ""
