#!/bin/bash
# =============================================================================
# Script 4: Migrate Pily -> Maria del Pilar Juliao
# =============================================================================
# Phone: 573126217704
# Source (DELETE): WSwsyZSoarT6V80Qos9D - "Pily Juliao" (nickname)
# Target (KEEP):   raNm6Es5sV7loB1kgLVl - "Maria del Pilar Juliao" (full name)
# =============================================================================
...
BAKERY="diana_lee"
SOURCE_USER="WSwsyZSoarT6V80Qos9D"
TARGET_USER="raNm6Es5sV7loB1kgLVl"

echo "=============================================="
echo "MIGRATE: Pily Juliao -> Maria del Pilar Juliao"
echo "Phone: 573126217704"
echo "Bakery: $BAKERY"
echo "=============================================="
echo ""
...
echo "Source User: $SOURCE_USER (Pily Juliao - nickname)"
echo ""
echo "Response:"
...
echo "Target User: $TARGET_USER (Maria del Pilar Juliao)"
echo ""
