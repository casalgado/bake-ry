#!/bin/bash
# =============================================================================
# Script 6: Migrate Maria Luisa (newer -> older)
# =============================================================================
# Phone: 573164719798
# Source (DELETE): nmg0JbK3cjvb7wBhc1nu - "Maria Luisa" (newer)
# Target (KEEP):   JOLwoNYQTMkhDBsvBn4s - "Maria Luisa" (older)
# Note: Same name, keeping older
# =============================================================================
...
BAKERY="diana_lee"
SOURCE_USER="nmg0JbK3cjvb7wBhc1nu"
TARGET_USER="JOLwoNYQTMkhDBsvBn4s"

echo "=============================================="
echo "MIGRATE: Maria Luisa (newer -> older)"
echo "Phone: 573164719798"
echo "Bakery: $BAKERY"
echo "=============================================="
echo ""
...
echo "Source User: $SOURCE_USER (Maria Luisa - newer)"
echo ""
echo "Response:"
...
echo "Target User: $TARGET_USER (Maria Luisa - older)"
echo ""
