const { db, auth, BAKERY_ID, ADMIN_USER_ID, timestamp } = require('../seedConfig-pastellus');
const bakery = require('../data/bakery-pastellus');
const settings = require('../data/settings-pastellus');
const { BakerySettings } = require('../../models/BakerySettings');
const productCollections = require('../data/productCollections-pastellus');
