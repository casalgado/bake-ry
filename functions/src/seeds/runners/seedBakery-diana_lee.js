const { db, auth, BAKERY_ID, ADMIN_USER_ID, timestamp } = require('../seedConfig-diana_lee');
const bakery = require('../data/bakery-diana_lee');
const settings = require('../data/settings-diana_lee');
const { BakerySettings } = require('../../models/BakerySettings');
const productCollections = require('../data/productCollections-diana_lee');
